package com.noteshare.validation;
...
public class Validation {  
    ...
    /** 
     * 电话号码正则表达式= (^[0-9]{3,4}\\-[0-9]{7,8}$)|(^[0-9]{7,8}$)  
     */
    public static final String PHONE = "(^[0-9]{3,4}\\-[0-9]{7,8}$)|(^[0-9]{7,8}$)" ;  
    /** 
...
////------------------验证方法       
    ...
    public static  boolean isValid(String str){  
    	boolean flag = true;
        if(null!=str && !"YES".equals(str.trim()) && !"NO".equals(str.trim())){
        	flag = false;
        }
        return flag;
    }  
