...
public class MyImgFilter {
	...
	public BufferedImage changeGrey() {
		...
		image = new BufferedImage(tempImg.getWidth(null), tempImg
	...
	public BufferedImage getGrey() {
		ColorConvertOp ccp = new ColorConvertOp(ColorSpace
	...
	public BufferedImage getRotate() {
		AffineTransformOp atop = new AffineTransformOp(AffineTransform
				.getRotateInstance(Math.PI, image.getWidth() / 2, image
						.getHeight() / 2),
	...
	public static void main(String[] args) throws IOException {
		...
		String pname = path.substring(0, path.lastIndexOf("."));
