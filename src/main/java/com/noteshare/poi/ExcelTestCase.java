...
import com.noteshare.apache.People;
...
public class ExcelTestCase {
    ...
    public void create() throws Exception{
        ...
        OutputStream os = new FileOutputStream(new File("E:/noteshare.xlsx"));
    ...
    public void createMax() throws Exception{
        ...
        byte[] buff = writer.exportExcel("测试例子", new String[]{"用户名","密码"}, list, null);
        OutputStream os = new FileOutputStream(new File("E:/mxnoteshare.xlsx"));
        IOUtils.write(buff, os);
    }
}